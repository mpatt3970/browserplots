...
NAME_MAP = ['Temperature', 'Dew Point', 'Relative Humidity', 'Pressure corrected to Sea Level', 'Wind Direction', 'Average Wind Speed', 'Peak Gust', 'Rain']
M_UNIT_MAP = ['Celsius', 'Celsius', 'percent', 'hPa', 'degrees', 'meters/second', 'meters/second', 'millimeters' ]
E_UNIT_MAP = ['Fahrenheit', 'Fahrenheit', 'percent', 'inches Hg', 'degrees', 'miles/hour', 'miles/hour', 'inches']
